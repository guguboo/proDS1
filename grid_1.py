...
output_filename = 'dataset_prediksi_statistik_3x3'
out_df = pd.DataFrame({
    'B1_min': B1_min, 'B1_mean': B1_mean, 'B1_max': B1_max, 
    'B2_min': B2_min, 'B2_mean': B2_mean, 'B2_max': B2_max, 
    'B3_min': B3_min, 'B3_mean': B3_mean, 'B3_max': B3_max, 
...
hasil_prediksi = pd.read_excel(script_directory +"/prediction_result/real_predict/hasil_prediksi_statistik_3x3.xlsx")
